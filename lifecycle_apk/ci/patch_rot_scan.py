...
def main() -> int:
    ...
    position_state = (SRC / "com/lifecyclebot/engine/truth/PositionStateLedger6454.kt").read_text()
    ...
    require(errors, position_state, "closingSinceMs6702", "TERMINAL_CAS_CLOSING_AGE_6702")
    require(errors, position_state, "recoverStalePaperClosing6702", "TERMINAL_CAS_STALE_RECOVERY_6702")
    require(errors, position_state, "PAPER_TERMINAL_STALE_CLOSING_RECOVERED_6702", "TERMINAL_CAS_STALE_RECOVERY_TELEMETRY_6702")
    require(errors, position_state, 'p.mode.equals("paper", true)', "TERMINAL_CAS_PAPER_ONLY_RECOVERY_6702")
    require(errors, position_state, "PAPER_STALE_CLOSING_MS_6702 = 30_000L", "TERMINAL_CAS_NORMAL_RECOVERY_TTL_6702")
    require(errors, position_state, "PAPER_EMERGENCY_STALE_CLOSING_MS_6702 = 2_000L", "TERMINAL_CAS_EMERGENCY_RECOVERY_TTL_6702")
