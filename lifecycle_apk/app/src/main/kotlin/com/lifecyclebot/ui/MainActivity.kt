...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    private fun updateUi(state: UiState) {
        ...
        if (openPos.isNotEmpty()) {
            // V5.0.7247 — HeroAccountSnapshot is deliberately portfolio-wide,
            // while this is the Solana MemeTrader card. Bind the header to the
            // exact filtered rows so HYPE/XMR/TBTC/WLFI exposure cannot leak in.
    ...
    private fun buildUnifiedOpenPositions(state: UiState): List<TokenState> {
        ...
        // V5.0.7135 — the last gate was a third copy of the same veto.
        //
        // Every row in `merged` has already passed the canonical test at its own
        // entry point, so re-testing here changed nothing for them — its only
    ...
    private fun render30DayMeme() {
        ...
        // V5.0.6086 — operator mandate: main UI displays must match the Journal.
        // The 30D/proof card lives on the main screen, so its headline figures use
