...
data class Position(
    ...
    val isOpen get(): Boolean {
        // Token units are not a dust threshold: one expensive token can fund many positions.
        if (!qtyToken.isFinite() || qtyToken <= 0.0) return false
    ...
    val hasTokens get() = qtyToken.isFinite() && qtyToken > 0.0
