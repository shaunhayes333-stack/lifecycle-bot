...
object ShitCoinTraderAI {
    ...
    private const val MAX_CONCURRENT_POSITIONS = 25   // V5.9.343: walk-back to V5.9.336
    ...
    private const val MAX_TOKEN_AGE_HOURS = 12.0      // V5.9.343: walk-back to V5.9.325
    ...
    fun closePosition(mint: String, exitPrice: Double, exitReason: ExitSignal) {
        ...
        try {
            ...
            // Without this, ShitCoin closes never reached TradeLessonRecorder → StrategyTrustAI,
            // leaving the trust dashboard with all 50%/UNTESTED for SHITCOIN despite hundreds of trades.
            try {
                ...
                // Feed AdaptiveLearningEngine for V5.9.301 pattern matching
                val label = when {
    ...
    fun checkExit(mint: String, currentPrice: Double): ExitSignal {
        ...
        // V5.9.444 — cutoff now fluid: reads HoldDurationTracker 0-1min
        // bucket for SHITCOIN and tightens toward the proven mean as data
    ...
    private const val SC_CONF_MATURE = 40             // V5.9.343: walk-back to V5.9.335
