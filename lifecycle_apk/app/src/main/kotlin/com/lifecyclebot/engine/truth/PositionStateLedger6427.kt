...
object PositionStateLedger6427 {
    ...
    fun registerOpen(positionId: String) {
        ...
        // V5.0.6448 — SOURCE-OF-TRUTH REPAIR.
        // Do NOT mirror registerOpen() into canonical here. This legacy ledger
        // only knows a display positionId/mint and zero cost, so 6444 created
        // zero-cost PENDING canonical rows that blocked the real executor BUY
        // mirror as an idempotency duplicate. Canonical lifecycle is now written
        // only from confirmed executor lifecycle events.
