...
class BotBrain(
    ...
    private fun restoreFromDatabase() {
        try {
            ...
            // Don't apply strict thresholds if we don't have enough data
            if (trades.size < 20) {
                onLog("🧠 Bootstrap mode: only ${trades.size} trades, keeping loose thresholds")
                entryThresholdDelta = -5.0  // Start loose
                return
            }
