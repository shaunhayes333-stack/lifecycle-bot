...
object OperatorChokeSourceContractSentinel {
    ...
    fun status(): String {
        ...
        return "OPERATOR_CHOKE_SOURCE_CONTRACT_SENTINEL_4416 contracts=${contracts.size} ids=[$ids] butterflies=[$butterflies] report_only=true no_execution_authority=true no_gate_change=true hard_safety_preserved=true release_visibility_required=true cache_first_required=true reject_taxonomy_required=true golden_tape_required=true"
    }
}
