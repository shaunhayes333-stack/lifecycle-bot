...
object OperatorChokeSourceContractSentinel {
    ...
    fun status(): String {
        ...
        return "OPERATOR_CHOKE_SOURCE_CONTRACT_SENTINEL_4416 contracts=${contracts.size} ids=[$ids] butterflies=[$butterflies] report_only=true no_execution_authority=true no_gate_change=true hard_safety_preserved=true release_visibility_required=true fep_false_return_route_visible_4416=true lane_release_false_visible_4419=true choke_visibility_bus_4421=true automode_paused_recovery_probe_4422=true cache_first_required=true reject_taxonomy_required=true reject_taxonomy_helper_4423=true golden_tape_required=true"
    }
}
